...
export type VizardAsset = { id: string; projectId: string; dramaSlug: string; episodeNumber: number; vizardVideoId: string; title: string; videoUrl: string; objectKey: string; durationSeconds: number; transcript?: string; viralScore?: string; viralReason?: string; clipEditorUrl?: string; metadata: Record<string, unknown>; createdAt: string };
