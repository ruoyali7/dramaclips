...
def render(asset,candidate,target,drama_cover,content_code,cover_duration=.1):
 ...
 graph=f"[0:v]{overlay},trim=duration={cover_duration},setpts=PTS-STARTPTS[cv];[1:v]{overlay},trim=duration={duration},setpts=PTS-STARTPTS[bodyv];[2:v]{overlay},trim=duration={ENDING_HOLD_SECONDS},setpts=PTS-STARTPTS,eq=saturation=0.92:contrast=1.04,drawbox=x=0:y=0:w=iw:h=ih:color=magenta@0.34:t=fill:enable='between(t\\,0.48\\,0.68)',drawbox=x=0:y=0:w=iw:h=ih:color=0xCFE8FF@0.78:t=fill:enable='between(t\\,0.68\\,0.82)',drawbox=x=0:y=0:w=iw:h=ih:color=white@0.58:t=fill:enable='between(t\\,0.84\\,0.94)',drawbox=x=0:y=0:w=iw:h=ih:color=0xF3B33D@0.32:t=fill:enable='between(t\\,0.94\\,1.12)',drawbox=x=0:y=0:w=iw:h=ih:color=0xD94B35@0.22:t=fill:enable='between(t\\,1.12\\,1.32)'[endv];[cv][bodyv][endv]concat=n=3:v=1:a=0[v];[1:a]asetpts=PTS-STARTPTS,afade=t=out:st={fade_start}:d=0.25,adelay={delay_ms}:all=1,apad,atrim=duration={total}[maina];anoisesrc=color=pink:amplitude=0.28:sample_rate=48000:d={ENDING_HOLD_SECONDS},highpass=f=80,lowpass=f=4000,afade=t=in:st=0:d=0.18,afade=t=out:st=1.25:d=0.75,adelay={fx_delay_ms+350}:all=1[whoosh];anoisesrc=color=white:amplitude=0.16:sample_rate=48000:d=0.38,highpass=f=1200,lowpass=f=9000,afade=t=in:st=0:d=0.03,afade=t=out:st=0.12:d=0.26,adelay={fx_delay_ms+680}:all=1[flash];sine=frequency=65:sample_rate=48000:duration=1.05,volume=0.38,afade=t=in:st=0:d=0.03,afade=t=out:st=0.3:d=0.75,adelay={fx_delay_ms+430}:all=1[bass];[maina][whoosh][flash][bass]amix=inputs=4:duration=longest:normalize=0,alimiter=limit=0.88,atrim=duration={total}[a]"
