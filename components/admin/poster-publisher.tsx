...
type PosterSource = { id:string; title:string; slug:string; contentCode:string; coverUrl:string; sourceCoverUrl:string; description:string; tags:string[]; contentPromotionUrl:string };
